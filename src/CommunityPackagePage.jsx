    ...
    <div className="community-page">
      ...
      <div className="community-body">
        ...
        <div className="community-left">
          ...
          <section>
            <div className="community-section-heading">Get this package</div>
            <p className="community-liability-notice">
              ...
              {!pkg.certified && ' This package has not yet been reviewed.'}
            </p>

            {/* Telegram CTA */}
            {pkg.telegram && (
              <div className="community-cta-telegram">
                <div className="community-cta-telegram-header">
                  <span className="community-cta-icon">💬</span>
                  <div>
                    <div className="community-cta-title">Try on Telegram</div>
                    <div className="community-cta-sub">Zero setup. Tap to start — your agent is ready in 2 minutes.</div>
                  </div>
                </div>
                <a
                  href={`https://t.me/AgentStandardAI_bot?start=${pkg.slug}`}
                  target="_blank"
                  rel="noreferrer"
                  className="community-cta-telegram-btn"
                >
                  Start {pkg.name} on Telegram →
                </a>
              </div>
            )}
