...
,
  ...
  },
  {
    ...
    description: 'A personal journalling companion that helps you build a reflective practice. Prompts thoughtful entries, tracks themes over time, and helps you see how your thinking evolves.',
    vertical: 'Lifestyle',
    setupTime: 3,
    tier: 'Free',
    certified: false,
    telegram: true,
    isNew: true,
    tags: ['Journal', 'Reflection', 'Memory'],
    rating: null,
    installs: 0,
    whatItDoes: [
      'Prompts daily reflection with questions tailored to what you bring',
      'Tracks recurring themes and surfaces patterns over time',
      'Remembers entries across sessions so your journal actually builds',
      'Helps you trace how your thinking and priorities evolve month to month',
    ],
    whoItsFor: 'Anyone who wants to think more clearly and remember what matters — without the friction of a blank page.',
    userLevel: 'beginner',
    discussionUrl: null,
  },
  {
    ...
    description: 'A personal fitness companion that logs workouts, tracks progress over time, and surfaces honest observations about your training — without the noise of a full coaching app.',
    vertical: 'Health',
    setupTime: 3,
    tier: 'Free',
    certified: false,
    ...
    installs: 0,
    whatItDoes: [
      'Logs workouts with sets, reps, weights, distance, or time',
      'Tracks progress and surfaces trends: strength gains, plateaus, consistency',
      'Notes recovery signals: sleep, soreness, and energy levels',
      'Builds a searchable history of every session',
    ],
    whoItsFor: 'Anyone who trains and wants a simple, honest log that actually helps them improve.',
    userLevel: 'beginner',
    discussionUrl: null,
  },
  {
    ...
    description: 'A personal habit coach that tracks what you commit to, follows up honestly, and helps you understand why habits stick or break — without the guilt of a streak counter.',
    vertical: 'Lifestyle',
    setupTime: 3,
    tier: 'Free',
    certified: false,
    ...
    installs: 0,
    whatItDoes: [
      'Tracks habits you commit to and follows up on them',
      'Diagnoses what breaks down when habits fail: trigger, timing, or motivation',
      'Applies habit science to your specific situation — not generic advice',
      'Distinguishes between a slip and a pattern, and helps you course-correct',
    ],
    whoItsFor: 'People who know what habits they want but keep starting over. This time with context.',
    userLevel: 'beginner',
    discussionUrl: null,
  },
  {
    ...
    description: 'A personal sleep coach that logs your sleep, identifies what affects it, and gives specific, actionable advice based on your patterns — not generic sleep hygiene lists.',
    vertical: 'Health',
    setupTime: 3,
    tier: 'Free',
    certified: false,
    ...
    installs: 0,
    whatItDoes: [
      'Logs sleep hours, quality, and patterns over time',
      'Identifies correlations: late nights, alcohol, stress, and exercise',
      'Gives specific, actionable coaching based on your personal data',
      'Flags anything that might warrant a GP conversation',
    ],
    whoItsFor: 'Anyone who feels tired and wants to understand why — and actually fix it.',
    userLevel: 'beginner',
    discussionUrl: null,
  },
  {
    ...
    description: 'A personal travel companion that helps you plan trips, remembers what worked, and builds a picture of you as a traveller so every recommendation is genuinely personal.',
    vertical: 'Lifestyle',
    setupTime: 3,
    tier: 'Free',
    certified: false,
    ...
    installs: 0,
    whatItDoes: [
      'Plans itineraries tailored to your travel style and preferences',
      'Remembers every trip: what you loved, what you\'d skip, where you\'d return',
      'Makes recommendations based on your taste, not generic best-of lists',
      'Captures restaurants, neighbourhoods, and things to do differently next time',
    ],
    whoItsFor: 'Travellers who want plans that feel personal and a companion who remembers where they\'ve been.',
    userLevel: 'beginner',
    discussionUrl: null,
  },
  {
    ...
    description: 'A full operating system for serious online sellers. Competitive intelligence, margin modelling, launch playbooks, conversion diagnostics, and a content engine — all in one agent.',
    vertical: 'Ecommerce',
    setupTime: 20,
    tier: 'Pro',
    certified: true,
    telegram: true,
    isNew: true,
    tags: ['Ecommerce', 'DTC', 'Growth'],
    rating: null,
    installs: 0,
    whatItDoes: [
      'Deep competitive analysis: pricing, positioning gaps, and review themes',
      'Margin modelling: platform fees, shipping, returns, and net margin per SKU',
      'Full product page copy: SEO title, bullets, descriptions, and CTAs ready to paste',
      'Launch playbooks: 4-week timeline with day-by-day actions for launch week',
      'Conversion audit: trust signals, PDP quality, funnel diagnosis, and prioritised fix list',
    ],
    whoItsFor: 'DTC founders and e-commerce operators who want a senior strategist on call — not another research tool.',
    userLevel: 'intermediate',
    discussionUrl: null,
  },
]
      ...
      <header className="hero">
        ...
        <div className="hero-split">
          ...
          <div className="hero-text-col">
            ...
            <div className="hero-stat-line">{totalPackages} packages live &nbsp;&middot;&nbsp; 11 verticals &nbsp;&middot;&nbsp; 60 seconds to personalise</div>
            ...
            <div className="hero-stats">
              <div className="stat"><strong>{totalPackages}</strong> packages</div>
