    ...
    <div className="detail-page">
      ...
      {currentStep === 0 && (
        <div className="package-hero">
          ...
          <p className="package-liability-notice">
            AgentStandard reviews packages against a published standard. Outputs are generated by the underlying AI model — AgentStandard is not liable for those outputs.
          </p>
          <p className="package-openclaw-note">
            The local install path is powered by <a href="https://openclaw.ai" target="_blank" rel="noreferrer">OpenClaw</a>, a free open-source AI agent platform.
          </p>
        </div>
      )}
